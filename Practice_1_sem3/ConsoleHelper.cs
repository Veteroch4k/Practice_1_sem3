...
namespace Practice_1_sem3
{
    class ConsoleHelper
    {
        private static List<FileDescription> files = [];
        ...
        private class FileDescription(string name, long size, DateTime changedTime) : IComparable<FileDescription>
        {
            private string name = name;

            private long size = size;

            private DateTime changedTime = changedTime;
